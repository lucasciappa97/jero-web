    ...
    <section className="p-6">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row gap-10 sm:gap-24 items-start">
        <div className="space-y-12 text-stone-700 leading-relaxed text-lg sm:w-6/12">
          ...
          <p className="text-gray-200 leading-relaxed max-w-prose text-xl antialiased">
            Desde entonces acompaño a personas que sienten que su carrera ya no
            las representa. Trabajo con líderes que saben que pueden dar más,
            pero no encuentran dirección. Guío equipos que necesitan redefinir
            su forma de operar para alcanzar resultados reales. Mi enfoque
            combina claridad estratégica, profundidad emocional y acción
            concreta.
          </p>
        </div>
